...
def get_user_nfts(wallet_address):
    ...
    # Retrieve the balance (number of NFTs) owned by the address
    contract_instance = w3.eth.contract(address=contract_address, abi=abi)
    balance = contract_instance.functions.balanceOf(wallet_address).call()

# Print the token IDs owned by the address
...
print(get_user_nfts("0x64e5F8009B4bF811dA62E119708335E86bE32b99"))
